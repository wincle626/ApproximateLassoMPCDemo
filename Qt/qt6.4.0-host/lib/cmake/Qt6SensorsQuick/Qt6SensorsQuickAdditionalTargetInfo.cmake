...
get_target_property(_qt_imported_location Qt6::SensorsQuick IMPORTED_LOCATION_RELEASE)
get_target_property(_qt_imported_soname Qt6::SensorsQuick IMPORTED_SONAME_RELEASE)
...
if(_qt_imported_location)
    set_property(TARGET Qt6::SensorsQuick PROPERTY IMPORTED_LOCATION_RELWITHDEBINFO "${_qt_imported_location}")
endif()
if(_qt_imported_soname)
    set_property(TARGET Qt6::SensorsQuick PROPERTY IMPORTED_SONAME_RELWITHDEBINFO "${_qt_imported_soname}")
endif()
...
if(_qt_imported_soname)
    set_property(TARGET Qt6::SensorsQuick PROPERTY IMPORTED_SONAME_MINSIZEREL "${_qt_imported_soname}")
endif()
