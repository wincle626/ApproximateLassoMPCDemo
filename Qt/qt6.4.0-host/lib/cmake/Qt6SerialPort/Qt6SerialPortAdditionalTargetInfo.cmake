...
get_target_property(_qt_imported_location Qt6::SerialPort IMPORTED_LOCATION_RELEASE)
get_target_property(_qt_imported_soname Qt6::SerialPort IMPORTED_SONAME_RELEASE)
...
if(_qt_imported_location)
    set_property(TARGET Qt6::SerialPort PROPERTY IMPORTED_LOCATION_RELWITHDEBINFO "${_qt_imported_location}")
endif()
if(_qt_imported_soname)
    set_property(TARGET Qt6::SerialPort PROPERTY IMPORTED_SONAME_RELWITHDEBINFO "${_qt_imported_soname}")
endif()

# Import target "Qt6::SerialPort" for configuration "MinSizeRel"
set_property(TARGET Qt6::SerialPort APPEND PROPERTY IMPORTED_CONFIGURATIONS MINSIZEREL)

if(_qt_imported_location)
    set_property(TARGET Qt6::SerialPort PROPERTY IMPORTED_LOCATION_MINSIZEREL "${_qt_imported_location}")
endif()
if(_qt_imported_soname)
    set_property(TARGET Qt6::SerialPort PROPERTY IMPORTED_SONAME_MINSIZEREL "${_qt_imported_soname}")
endif()
