...
get_target_property(_qt_imported_location Qt6::balsam IMPORTED_LOCATION_RELEASE)
...
if(_qt_imported_location)
    set_property(TARGET Qt6::balsam PROPERTY IMPORTED_LOCATION_RELWITHDEBINFO "${_qt_imported_location}")
endif()
...
get_target_property(_qt_imported_location Qt6::balsamui IMPORTED_LOCATION_RELEASE)
get_target_property(_qt_imported_location_default Qt6::balsamui IMPORTED_LOCATION_${QT_DEFAULT_IMPORT_CONFIGURATION})

# Import target "Qt6::balsamui" for configuration "RelWithDebInfo"
set_property(TARGET Qt6::balsamui APPEND PROPERTY IMPORTED_CONFIGURATIONS RELWITHDEBINFO)

if(_qt_imported_location)
    set_property(TARGET Qt6::balsamui PROPERTY IMPORTED_LOCATION_RELWITHDEBINFO "${_qt_imported_location}")
endif()
...
get_target_property(_qt_imported_location Qt6::meshdebug IMPORTED_LOCATION_RELEASE)
...
if(_qt_imported_location)
    set_property(TARGET Qt6::meshdebug PROPERTY IMPORTED_LOCATION_RELWITHDEBINFO "${_qt_imported_location}")
endif()
...
get_target_property(_qt_imported_location Qt6::shadergen IMPORTED_LOCATION_RELEASE)
...
if(_qt_imported_location)
    set_property(TARGET Qt6::shadergen PROPERTY IMPORTED_LOCATION_RELWITHDEBINFO "${_qt_imported_location}")
endif()
...
get_target_property(_qt_imported_location Qt6::instancer IMPORTED_LOCATION_RELEASE)
get_target_property(_qt_imported_location_default Qt6::instancer IMPORTED_LOCATION_${QT_DEFAULT_IMPORT_CONFIGURATION})

# Import target "Qt6::instancer" for configuration "RelWithDebInfo"
set_property(TARGET Qt6::instancer APPEND PROPERTY IMPORTED_CONFIGURATIONS RELWITHDEBINFO)

if(_qt_imported_location)
    set_property(TARGET Qt6::instancer PROPERTY IMPORTED_LOCATION_RELWITHDEBINFO "${_qt_imported_location}")
endif()
...
get_target_property(_qt_imported_location Qt6::shapegen IMPORTED_LOCATION_RELEASE)
get_target_property(_qt_imported_location_default Qt6::shapegen IMPORTED_LOCATION_${QT_DEFAULT_IMPORT_CONFIGURATION})

# Import target "Qt6::shapegen" for configuration "RelWithDebInfo"
set_property(TARGET Qt6::shapegen APPEND PROPERTY IMPORTED_CONFIGURATIONS RELWITHDEBINFO)

if(_qt_imported_location)
    set_property(TARGET Qt6::shapegen PROPERTY IMPORTED_LOCATION_RELWITHDEBINFO "${_qt_imported_location}")
endif()
...
get_target_property(_qt_imported_location Qt6::materialeditor IMPORTED_LOCATION_RELEASE)
get_target_property(_qt_imported_location_default Qt6::materialeditor IMPORTED_LOCATION_${QT_DEFAULT_IMPORT_CONFIGURATION})

# Import target "Qt6::materialeditor" for configuration "RelWithDebInfo"
set_property(TARGET Qt6::materialeditor APPEND PROPERTY IMPORTED_CONFIGURATIONS RELWITHDEBINFO)

if(_qt_imported_location)
    set_property(TARGET Qt6::materialeditor PROPERTY IMPORTED_LOCATION_RELWITHDEBINFO "${_qt_imported_location}")
endif()
