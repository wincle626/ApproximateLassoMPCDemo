...
get_target_property(_qt_imported_location Qt6::qquick3dplugin IMPORTED_LOCATION_RELEASE)
...
if(_qt_imported_location)
    set_property(TARGET Qt6::qquick3dplugin PROPERTY IMPORTED_LOCATION_RELWITHDEBINFO "${_qt_imported_location}")
endif()

# Import target "Qt6::qquick3dplugin" for configuration "MinSizeRel"
set_property(TARGET Qt6::qquick3dplugin APPEND PROPERTY IMPORTED_CONFIGURATIONS MINSIZEREL)

if(_qt_imported_location)
    set_property(TARGET Qt6::qquick3dplugin PROPERTY IMPORTED_LOCATION_MINSIZEREL "${_qt_imported_location}")
endif()
