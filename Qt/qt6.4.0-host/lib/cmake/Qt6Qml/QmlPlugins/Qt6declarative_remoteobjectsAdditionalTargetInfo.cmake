...
get_target_property(_qt_imported_location Qt6::declarative_remoteobjects IMPORTED_LOCATION_RELEASE)
...
if(_qt_imported_location)
    set_property(TARGET Qt6::declarative_remoteobjects PROPERTY IMPORTED_LOCATION_RELWITHDEBINFO "${_qt_imported_location}")
endif()

# Import target "Qt6::declarative_remoteobjects" for configuration "MinSizeRel"
set_property(TARGET Qt6::declarative_remoteobjects APPEND PROPERTY IMPORTED_CONFIGURATIONS MINSIZEREL)

if(_qt_imported_location)
    set_property(TARGET Qt6::declarative_remoteobjects PROPERTY IMPORTED_LOCATION_MINSIZEREL "${_qt_imported_location}")
endif()
