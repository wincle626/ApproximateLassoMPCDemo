...
if (NOT QT_NO_CREATE_TARGETS AND Qt6Qml_FOUND)
    ...
    if(NOT Qt6Qml_DEFINITIONS)
        ...
        list(TRANSFORM Qt6Qml_DEFINITIONS PREPEND "-D")
    endif()
    ...
    foreach(_module_dep ${_Qt6Qml_MODULE_DEPENDENCIES})
        list(APPEND Qt6Qml_INCLUDE_DIRS
             ${Qt6${_module_dep}_INCLUDE_DIRS})
        list(APPEND Qt6Qml_PRIVATE_INCLUDE_DIRS
             ${Qt6${_module_dep}_PRIVATE_INCLUDE_DIRS})
        list(APPEND Qt6Qml_DEFINITIONS
             ${Qt6${_module_dep}_DEFINITIONS})
        list(APPEND Qt6Qml_COMPILE_DEFINITIONS
...
if (TARGET Qt6::Qml)
    foreach(extra_cmake_include Qt6QmlMacros.cmake;Qt6QmlConfigExtras.cmake;Qt6QmlFindQmlscInternal.cmake)
