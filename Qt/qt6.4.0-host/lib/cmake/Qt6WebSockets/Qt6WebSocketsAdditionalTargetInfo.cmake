...
get_target_property(_qt_imported_location Qt6::WebSockets IMPORTED_LOCATION_RELEASE)
get_target_property(_qt_imported_soname Qt6::WebSockets IMPORTED_SONAME_RELEASE)
...
if(_qt_imported_location)
    set_property(TARGET Qt6::WebSockets PROPERTY IMPORTED_LOCATION_RELWITHDEBINFO "${_qt_imported_location}")
endif()
if(_qt_imported_soname)
    set_property(TARGET Qt6::WebSockets PROPERTY IMPORTED_SONAME_RELWITHDEBINFO "${_qt_imported_soname}")
endif()
...
if(_qt_imported_soname)
    set_property(TARGET Qt6::WebSockets PROPERTY IMPORTED_SONAME_MINSIZEREL "${_qt_imported_soname}")
endif()
