...
set_target_properties(Qt6::moc PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/./libexec/moc"
  )
...
set_target_properties(Qt6::rcc PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/./libexec/rcc"
  )
...
set_target_properties(Qt6::tracegen PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/./libexec/tracegen"
  )
...
set_target_properties(Qt6::cmake_automoc_parser PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/./libexec/cmake_automoc_parser"
  )
...
set_target_properties(Qt6::qlalr PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/./libexec/qlalr"
  )
...
list(APPEND _IMPORT_CHECK_TARGETS Qt6::qtpaths )
list(APPEND _IMPORT_CHECK_FILES_FOR_Qt6::qtpaths "${_IMPORT_PREFIX}/bin/qtpaths" )
...
list(APPEND _IMPORT_CHECK_TARGETS Qt6::androiddeployqt )
list(APPEND _IMPORT_CHECK_FILES_FOR_Qt6::androiddeployqt "${_IMPORT_PREFIX}/bin/androiddeployqt" )
...
list(APPEND _IMPORT_CHECK_TARGETS Qt6::androidtestrunner )
list(APPEND _IMPORT_CHECK_FILES_FOR_Qt6::androidtestrunner "${_IMPORT_PREFIX}/bin/androidtestrunner" )
