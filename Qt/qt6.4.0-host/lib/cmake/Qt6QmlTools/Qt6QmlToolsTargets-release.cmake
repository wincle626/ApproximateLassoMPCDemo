...
list(APPEND _IMPORT_CHECK_TARGETS Qt6::qmltyperegistrar )
list(APPEND _IMPORT_CHECK_FILES_FOR_Qt6::qmltyperegistrar "${_IMPORT_PREFIX}/./libexec/qmltyperegistrar" )
...
list(APPEND _IMPORT_CHECK_TARGETS Qt6::qmlcachegen )
list(APPEND _IMPORT_CHECK_FILES_FOR_Qt6::qmlcachegen "${_IMPORT_PREFIX}/./libexec/qmlcachegen" )
...
list(APPEND _IMPORT_CHECK_FILES_FOR_Qt6::qmldom "${_IMPORT_PREFIX}/bin/qmldom" )
...
list(APPEND _IMPORT_CHECK_TARGETS Qt6::qmllint )
list(APPEND _IMPORT_CHECK_FILES_FOR_Qt6::qmllint "${_IMPORT_PREFIX}/bin/qmllint" )
...
list(APPEND _IMPORT_CHECK_TARGETS Qt6::qmltc )
list(APPEND _IMPORT_CHECK_FILES_FOR_Qt6::qmltc "${_IMPORT_PREFIX}/bin/qmltc" )
...
list(APPEND _IMPORT_CHECK_TARGETS Qt6::qmlimportscanner )
list(APPEND _IMPORT_CHECK_FILES_FOR_Qt6::qmlimportscanner "${_IMPORT_PREFIX}/./libexec/qmlimportscanner" )
...
list(APPEND _IMPORT_CHECK_TARGETS Qt6::qmlformat )
list(APPEND _IMPORT_CHECK_FILES_FOR_Qt6::qmlformat "${_IMPORT_PREFIX}/bin/qmlformat" )
...
list(APPEND _IMPORT_CHECK_TARGETS Qt6::qmlprofiler )
list(APPEND _IMPORT_CHECK_FILES_FOR_Qt6::qmlprofiler "${_IMPORT_PREFIX}/bin/qmlprofiler" )
...
list(APPEND _IMPORT_CHECK_TARGETS Qt6::qmltime )
list(APPEND _IMPORT_CHECK_FILES_FOR_Qt6::qmltime "${_IMPORT_PREFIX}/bin/qmltime" )
...
list(APPEND _IMPORT_CHECK_TARGETS Qt6::qmlplugindump )
list(APPEND _IMPORT_CHECK_FILES_FOR_Qt6::qmlplugindump "${_IMPORT_PREFIX}/bin/qmlplugindump" )
...
list(APPEND _IMPORT_CHECK_TARGETS Qt6::qmltestrunner )
list(APPEND _IMPORT_CHECK_FILES_FOR_Qt6::qmltestrunner "${_IMPORT_PREFIX}/bin/qmltestrunner" )
