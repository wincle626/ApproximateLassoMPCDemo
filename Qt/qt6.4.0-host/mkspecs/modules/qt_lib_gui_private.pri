QT.gui_private.VERSION = 6.4.0
QT.gui_private.name = QtGui
QT.gui_private.module =
QT.gui_private.libs = $$QT_MODULE_LIB_BASE
QT.gui_private.includes = $$QT_MODULE_INCLUDE_BASE/QtGui/6.4.0 $$QT_MODULE_INCLUDE_BASE/QtGui/6.4.0/QtGui
...
QT.gui_private.enabled_features = accessibility-atspi-bridge evdev freetype system-freetype fontconfig harfbuzz kms drm_atomic libinput libinput-axis-api libinput-hires-wheel-support linuxfb vnc mtdev vkgen egl_x11 eglfs eglfs_egldevice eglfs_gbm eglfs_x11 gif ico jpeg system-jpeg png system-png imageio-text-loading tslib tuiotouch xcb-glx xcb-egl-plugin xcb-xlib xcb-sm xkbcommon xkbcommon-x11 xlib multiprocess raster-64bit raster-fp
QT.gui_private.disabled_features = directfb directwrite directwrite3 direct2d direct2d1_1 system-harfbuzz qqnx_imf integrityfb integrityhid vsp2 vkkhrdisplay eglfs_brcm eglfs_vsp2 eglfs_mali eglfs_viv eglfs_rcar eglfs_viv_wl eglfs_openwfd xcb-native-painting xrender system-xcb-xinput
QMAKE_INCDIR_ATSPI = /usr/lib/aarch64-linux-gnu/dbus-1.0/include /usr/lib/aarch64-linux-gnu/glib-2.0/include
QMAKE_LIBS_ATSPI = -lglib-2.0 -ldbus-1 -latspi
QMAKE_LIBS_DIRECTFB = -lpthread -ldirect -lfusion -lpthread -ldirectfb
QMAKE_LIBS_DRM = -ldrm
QMAKE_LIBS_EGL = -lEGL
