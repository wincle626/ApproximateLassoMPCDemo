...
#ifndef TEXT_INPUT_UNSTABLE_V4_WIP_CLIENT_PROTOCOL_H
#define TEXT_INPUT_UNSTABLE_V4_WIP_CLIENT_PROTOCOL_H
...
#ifndef ZWP_TEXT_INPUT_V4_INTERFACE
#define ZWP_TEXT_INPUT_V4_INTERFACE
/**
...
#endif
#ifndef ZWP_TEXT_INPUT_MANAGER_V4_INTERFACE
#define ZWP_TEXT_INPUT_MANAGER_V4_INTERFACE
/**
...
/**
 * @ingroup iface_zwp_text_input_v4
 * @struct zwp_text_input_v4_listener
 */
struct zwp_text_input_v4_listener {
	/**
	 * enter event
	...
	void (*enter)(void *data,
		      struct zwp_text_input_v4 *zwp_text_input_v4,
	 ...
	 * applied and reset to initial on the next zwp_text_input_v4.done
	 * event.
	 *
	 ...
	 * zwp_text_input_v4 object known to the compositor. The value of
	 ...
	 * change the current state of the zwp_text_input_v4 object.
	 */
	void (*done)(void *data,
		     struct zwp_text_input_v4 *zwp_text_input_v4,
		     uint32_t serial);
	 ...
	 * switching the focus widget or changing the cursor position,
	 * whether to commit the preedit text or clear the preedit text.
	 *
	 * This is usually used together with the preedit_string event.
	 *
	 * The commit behavior is the same for focus switch and cursor
	 * position change.
	 *
	 * The parameter mode selects the desired behavior and its value is
	 * one from the commit mode enum.
	 */
	void (*preedit_commit_mode)(void *data,
				    struct zwp_text_input_v4 *zwp_text_input_v4,
				    uint32_t mode);
};
 ...
 */
static inline int
zwp_text_input_v4_add_listener(struct zwp_text_input_v4 *zwp_text_input_v4,
			       const struct zwp_text_input_v4_listener *listener, void *data)
{
	return wl_proxy_add_listener((struct wl_proxy *) zwp_text_input_v4,
				     (void (**)(void)) listener, data);
}

#define ZWP_TEXT_INPUT_V4_DESTROY 0
#define ZWP_TEXT_INPUT_V4_ENABLE 1
#define ZWP_TEXT_INPUT_V4_DISABLE 2
#define ZWP_TEXT_INPUT_V4_SET_SURROUNDING_TEXT 3
#define ZWP_TEXT_INPUT_V4_SET_TEXT_CHANGE_CAUSE 4
#define ZWP_TEXT_INPUT_V4_SET_CONTENT_TYPE 5
#define ZWP_TEXT_INPUT_V4_SET_CURSOR_RECTANGLE 6
#define ZWP_TEXT_INPUT_V4_COMMIT 7
...
/** @ingroup iface_zwp_text_input_v4 */
static inline void
zwp_text_input_v4_set_user_data(struct zwp_text_input_v4 *zwp_text_input_v4, void *user_data)
{
	wl_proxy_set_user_data((struct wl_proxy *) zwp_text_input_v4, user_data);
}

/** @ingroup iface_zwp_text_input_v4 */
static inline void *
zwp_text_input_v4_get_user_data(struct zwp_text_input_v4 *zwp_text_input_v4)
{
	return wl_proxy_get_user_data((struct wl_proxy *) zwp_text_input_v4);
}

static inline uint32_t
zwp_text_input_v4_get_version(struct zwp_text_input_v4 *zwp_text_input_v4)
{
	return wl_proxy_get_version((struct wl_proxy *) zwp_text_input_v4);
}
 ...
 */
static inline void
zwp_text_input_v4_destroy(struct zwp_text_input_v4 *zwp_text_input_v4)
{
	wl_proxy_marshal_flags((struct wl_proxy *) zwp_text_input_v4,
			 ZWP_TEXT_INPUT_V4_DESTROY, NULL, wl_proxy_get_version((struct wl_proxy *) zwp_text_input_v4), WL_MARSHAL_FLAG_DESTROY);
}
 ...
 */
static inline void
zwp_text_input_v4_enable(struct zwp_text_input_v4 *zwp_text_input_v4)
{
	wl_proxy_marshal_flags((struct wl_proxy *) zwp_text_input_v4,
			 ZWP_TEXT_INPUT_V4_ENABLE, NULL, wl_proxy_get_version((struct wl_proxy *) zwp_text_input_v4), 0);
}
 ...
 */
static inline void
zwp_text_input_v4_disable(struct zwp_text_input_v4 *zwp_text_input_v4)
{
	wl_proxy_marshal_flags((struct wl_proxy *) zwp_text_input_v4,
			 ZWP_TEXT_INPUT_V4_DISABLE, NULL, wl_proxy_get_version((struct wl_proxy *) zwp_text_input_v4), 0);
}
 ...
 */
static inline void
zwp_text_input_v4_set_surrounding_text(struct zwp_text_input_v4 *zwp_text_input_v4, const char *text, int32_t cursor, int32_t anchor)
{
	wl_proxy_marshal_flags((struct wl_proxy *) zwp_text_input_v4,
			 ZWP_TEXT_INPUT_V4_SET_SURROUNDING_TEXT, NULL, wl_proxy_get_version((struct wl_proxy *) zwp_text_input_v4), 0, text, cursor, anchor);
}
 ...
 */
static inline void
zwp_text_input_v4_set_text_change_cause(struct zwp_text_input_v4 *zwp_text_input_v4, uint32_t cause)
{
	wl_proxy_marshal_flags((struct wl_proxy *) zwp_text_input_v4,
			 ZWP_TEXT_INPUT_V4_SET_TEXT_CHANGE_CAUSE, NULL, wl_proxy_get_version((struct wl_proxy *) zwp_text_input_v4), 0, cause);
}
 ...
 */
static inline void
zwp_text_input_v4_set_content_type(struct zwp_text_input_v4 *zwp_text_input_v4, uint32_t hint, uint32_t purpose)
{
	wl_proxy_marshal_flags((struct wl_proxy *) zwp_text_input_v4,
			 ZWP_TEXT_INPUT_V4_SET_CONTENT_TYPE, NULL, wl_proxy_get_version((struct wl_proxy *) zwp_text_input_v4), 0, hint, purpose);
}
 ...
 */
static inline void
zwp_text_input_v4_set_cursor_rectangle(struct zwp_text_input_v4 *zwp_text_input_v4, int32_t x, int32_t y, int32_t width, int32_t height)
{
	wl_proxy_marshal_flags((struct wl_proxy *) zwp_text_input_v4,
			 ZWP_TEXT_INPUT_V4_SET_CURSOR_RECTANGLE, NULL, wl_proxy_get_version((struct wl_proxy *) zwp_text_input_v4), 0, x, y, width, height);
}
 ...
 */
static inline void
zwp_text_input_v4_commit(struct zwp_text_input_v4 *zwp_text_input_v4)
{
	wl_proxy_marshal_flags((struct wl_proxy *) zwp_text_input_v4,
			 ZWP_TEXT_INPUT_V4_COMMIT, NULL, wl_proxy_get_version((struct wl_proxy *) zwp_text_input_v4), 0);
}

#define ZWP_TEXT_INPUT_MANAGER_V4_DESTROY 0
#define ZWP_TEXT_INPUT_MANAGER_V4_GET_TEXT_INPUT 1
...
/** @ingroup iface_zwp_text_input_manager_v4 */
static inline void
zwp_text_input_manager_v4_set_user_data(struct zwp_text_input_manager_v4 *zwp_text_input_manager_v4, void *user_data)
{
	wl_proxy_set_user_data((struct wl_proxy *) zwp_text_input_manager_v4, user_data);
}

/** @ingroup iface_zwp_text_input_manager_v4 */
static inline void *
zwp_text_input_manager_v4_get_user_data(struct zwp_text_input_manager_v4 *zwp_text_input_manager_v4)
{
	return wl_proxy_get_user_data((struct wl_proxy *) zwp_text_input_manager_v4);
}

static inline uint32_t
zwp_text_input_manager_v4_get_version(struct zwp_text_input_manager_v4 *zwp_text_input_manager_v4)
{
	return wl_proxy_get_version((struct wl_proxy *) zwp_text_input_manager_v4);
}
 ...
 */
static inline void
zwp_text_input_manager_v4_destroy(struct zwp_text_input_manager_v4 *zwp_text_input_manager_v4)
{
	wl_proxy_marshal_flags((struct wl_proxy *) zwp_text_input_manager_v4,
			 ZWP_TEXT_INPUT_MANAGER_V4_DESTROY, NULL, wl_proxy_get_version((struct wl_proxy *) zwp_text_input_manager_v4), WL_MARSHAL_FLAG_DESTROY);
}
 ...
 */
static inline struct zwp_text_input_v4 *
zwp_text_input_manager_v4_get_text_input(struct zwp_text_input_manager_v4 *zwp_text_input_manager_v4, struct wl_seat *seat)
{
	struct wl_proxy *id;

	id = wl_proxy_marshal_flags((struct wl_proxy *) zwp_text_input_manager_v4,
			 ZWP_TEXT_INPUT_MANAGER_V4_GET_TEXT_INPUT, &zwp_text_input_v4_interface, wl_proxy_get_version((struct wl_proxy *) zwp_text_input_manager_v4), 0, NULL, seat);

	return (struct zwp_text_input_v4 *) id;
}
