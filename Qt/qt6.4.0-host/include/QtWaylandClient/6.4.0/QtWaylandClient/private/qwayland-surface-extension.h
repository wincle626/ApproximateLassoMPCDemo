...
// source file is /home/udrc/qt5/qtwayland/src/client/../extensions/surface-extension.xml
...
#    else
#      define Q_WAYLAND_CLIENT_SURFACE_EXTENSION_EXPORT Q_DECL_IMPORT
#    endif
#  else
...
namespace QtWayland {
    ...
    {
    public:
        qt_surface_extension(struct ::wl_registry *registry, uint32_t id, int version);
    ...
    {
    public:
        qt_extended_surface(struct ::wl_registry *registry, uint32_t id, int version);
