...
// source file is /home/udrc/qt5/qtwayland/src/client/../extensions/touch-extension.xml
...
#    else
#      define Q_WAYLAND_CLIENT_TOUCH_EXTENSION_EXPORT Q_DECL_IMPORT
#    endif
#  else
...
namespace QtWayland {
    ...
    {
    public:
        qt_touch_extension(struct ::wl_registry *registry, uint32_t id, int version);
