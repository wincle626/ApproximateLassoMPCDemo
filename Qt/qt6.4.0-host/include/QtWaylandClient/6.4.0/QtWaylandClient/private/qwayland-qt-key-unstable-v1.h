...
// source file is /home/udrc/qt5/qtwayland/src/client/../extensions/qt-key-unstable-v1.xml
...
#    else
#      define Q_WAYLAND_CLIENT_QT_KEY_UNSTABLE_V1_EXPORT Q_DECL_IMPORT
#    endif
#  else
...
namespace QtWayland {
    ...
    {
    public:
        zqt_key_v1(struct ::wl_registry *registry, uint32_t id, int version);
