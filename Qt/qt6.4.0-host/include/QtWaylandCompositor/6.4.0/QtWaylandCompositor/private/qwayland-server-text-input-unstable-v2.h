...
// source file is /home/udrc/qt5/qtwayland/src/compositor/../3rdparty/protocol/text-input-unstable-v2.xml
...
#    else
#      define Q_WAYLAND_SERVER_TEXT_INPUT_UNSTABLE_V2_EXPORT Q_DECL_IMPORT
#    endif
#  else
...
namespace QtWaylandServer {
    ...
    {
    public:
        zwp_text_input_v2(struct ::wl_client *client, uint32_t id, int version);
    ...
    {
    public:
        zwp_text_input_manager_v2(struct ::wl_client *client, uint32_t id, int version);
