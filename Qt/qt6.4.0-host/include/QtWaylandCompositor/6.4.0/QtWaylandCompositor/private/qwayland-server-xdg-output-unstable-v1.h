...
// source file is /home/udrc/qt5/qtwayland/src/compositor/../3rdparty/protocol/xdg-output-unstable-v1.xml
...
#    else
#      define Q_WAYLAND_SERVER_XDG_OUTPUT_UNSTABLE_V1_EXPORT Q_DECL_IMPORT
#    endif
#  else
...
namespace QtWaylandServer {
    ...
    {
    public:
        zxdg_output_manager_v1(struct ::wl_client *client, uint32_t id, int version);
    ...
    {
    public:
        zxdg_output_v1(struct ::wl_client *client, uint32_t id, int version);
