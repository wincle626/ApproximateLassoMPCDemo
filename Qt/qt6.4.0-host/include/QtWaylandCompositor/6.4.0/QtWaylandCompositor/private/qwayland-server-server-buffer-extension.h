...
// source file is /home/udrc/qt5/qtwayland/src/compositor/../extensions/server-buffer-extension.xml
...
#    else
#      define Q_WAYLAND_SERVER_SERVER_BUFFER_EXTENSION_EXPORT Q_DECL_IMPORT
#    endif
#  else
...
namespace QtWaylandServer {
    ...
    {
    public:
        qt_server_buffer(struct ::wl_client *client, uint32_t id, int version);
