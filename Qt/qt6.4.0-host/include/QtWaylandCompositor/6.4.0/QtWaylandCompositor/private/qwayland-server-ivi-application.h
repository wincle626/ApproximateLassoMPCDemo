...
// source file is /home/udrc/qt5/qtwayland/src/compositor/../3rdparty/protocol/ivi-application.xml
...
#    else
#      define Q_WAYLAND_SERVER_IVI_APPLICATION_EXPORT Q_DECL_IMPORT
#    endif
#  else
...
namespace QtWaylandServer {
    ...
    {
    public:
        ivi_surface(struct ::wl_client *client, uint32_t id, int version);
    ...
    {
    public:
        ivi_application(struct ::wl_client *client, uint32_t id, int version);
