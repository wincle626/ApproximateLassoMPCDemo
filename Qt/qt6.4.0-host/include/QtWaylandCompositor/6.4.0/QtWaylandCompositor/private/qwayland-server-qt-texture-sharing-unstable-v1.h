...
// source file is /home/udrc/qt5/qtwayland/src/compositor/../extensions/qt-texture-sharing-unstable-v1.xml
...
#    else
#      define Q_WAYLAND_SERVER_QT_TEXTURE_SHARING_UNSTABLE_V1_EXPORT Q_DECL_IMPORT
#    endif
#  else
...
namespace QtWaylandServer {
    ...
    {
    public:
        zqt_texture_sharing_v1(struct ::wl_client *client, uint32_t id, int version);
