...
// source file is /home/udrc/qt5/qtwayland/src/compositor/../extensions/hardware-integration.xml
...
#    else
#      define Q_WAYLAND_SERVER_HARDWARE_INTEGRATION_EXPORT Q_DECL_IMPORT
#    endif
#  else
...
namespace QtWaylandServer {
    ...
    {
    public:
        qt_hardware_integration(struct ::wl_client *client, uint32_t id, int version);
        ...
        {
        public:
            Resource() : hardware_integration_object(nullptr), handle(nullptr) {}
            virtual ~Resource() {}

            qt_hardware_integration *hardware_integration_object;
            qt_hardware_integration *object() { return hardware_integration_object; } 
    ...
    private:
        ...
        struct DisplayDestroyedListener : ::wl_listener {
            qt_hardware_integration *parent;
        };
